...
// Routes
// ==============================================
export default async function customerAttributionsRoutes(fastify) {
    // GET /api/v1/customer-attributions - Liste aller Attributionen
    fastify.get('/api/v1/customer-attributions', async (request, reply) => {
    ...
    fastify.get('/api/v1/customer-attributions/:userId', async (request, reply) => {
    ...
    fastify.post('/api/v1/customer-attributions', async (request, reply) => {
    ...
    fastify.post('/api/v1/customer-attributions/:userId/record-purchase', async (request, reply) => {
        const { userId } = request.params;
    ...
    fastify.delete('/api/v1/customer-attributions/:userId', async (request, reply) => {
        const { userId } = request.params;
    ...
    fastify.get('/api/v1/customer-attributions/stats', async (request, reply) => {
        ...
        const [total, active, withPurchase, aggregates,] = await Promise.all([
            prisma.customerAttribution.count({ where }),
    ...
    fastify.post('/api/v1/customer-attributions/check', async (request, reply) => {
        const input = z.object({
...
//# sourceMappingURL=customer-attributions.js.map