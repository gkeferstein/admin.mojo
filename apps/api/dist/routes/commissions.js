...
import { commissionCalculator } from '../services/commission-calculator.js';
...
// Routes
// ==============================================
export default async function commissionsRoutes(fastify) {
    // POST /api/v1/commissions/calculate - Provisionen berechnen (Preview)
    fastify.post('/api/v1/commissions/calculate', async (request, reply) => {
    ...
    fastify.post('/api/v1/commissions/process', async (request, reply) => {
        const input = calculateSchema.parse(request.body);
    ...
    fastify.get('/api/v1/commissions', async (request, reply) => {
    ...
    fastify.get('/api/v1/commissions/by-order/:orderId', async (request, reply) => {
    ...
    fastify.post('/api/v1/commissions/refund', async (request, reply) => {
    ...
    fastify.post('/api/v1/commissions/approve-eligible', async (request, reply) => {
    ...
    fastify.get('/api/v1/commissions/stats', async (request, reply) => {
        const { recipientTenantId, period } = request.query;
        const where = {};
    ...
    fastify.get('/api/v1/commissions/pending-payout', async (request, reply) => {
